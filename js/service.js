...
ad.decisions = [{
    ...
    },
    {
        ...
        button: 'Прочее',
        color: 'btn-dark',
        desc: 'Например, неправильно указана марка / модель, или несколько причин, все фатальные'
    },
    {
        decision: 'leasing',
    ...
    },
    {
        ...
        button: 'Непонятно',
        color: 'btn-secondary',
        desc: 'Из объявления непонятно, есть ли НДС в цене, но больше никаких проблем не заметно'
    },
    {
        decision: 'ok',
        button: 'Все ОК',
